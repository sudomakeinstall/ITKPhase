 ...
 *
 *=========================================================================*/
#ifndef itkPhaseMedianImageFilter_h
#define itkPhaseMedianImageFilter_h
...
namespace itk
{
/** \class PhaseMedianImageFilter
 * \brief Calculates the median wrapped phase in an nxn neighborhood.
 *
 * This filter assumes a phase image wrapped into the range of -pi to pi as input and
 * calculates the median phase in an nxn neighborhood.
 *
...
public:
  ...
  typedef PhaseMedianImageFilter                               Self;
  ...
  itkTypeMacro(PhaseMedianImageFilter, PhaseImageToImageFilter);
...
protected:
  ...
  typedef MedianImageFilter< TOutputImage, TOutputImage >                 MedianType;
...
private:
  ...
  ITK_DISALLOW_COPY_AND_ASSIGN(PhaseMedianImageFilter);
  ...
  typename MedianType::Pointer   m_MedianSin;
  typename MedianType::Pointer   m_MedianCos;
...
#include "itkPhaseMedianImageFilter.hxx"
#endif
